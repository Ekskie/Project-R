...
@export var port_entry :LineEdit # <-- NEW: Assign a new LineEdit here in the inspector (optional)
...
func _on_join_pressed():
	...
	# NEW: Check if the player pasted an IP and Port together (e.g. "my-server.playit.gg:12259")
	if ":" in input_address:
